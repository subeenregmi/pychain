...
class Block():
    ...
    def validateBlock(self):
        ...
        checkid = hashlib.sha256(checkid.encode('utf-8')).hexdigest()[2:]
...
def main():
    ...
    x.mine("ab696a951348d80c9360d0de0733eef12c6cd64e7bbaaf658acee42a61d32d60")
    x.validateBlock()
    print(x.raw)
